...
verifiedAt: "2026-08-04T20:39:58.278Z"
userVerifiedAt: null
...
workRecord:
    ...
    path: "docs/work-records/2026-08-04-model-welcome-and-auth-commands-de-seamed-onto-real-machinery.md"
    lastAttemptAt: "2026-08-04T21:27:35.235Z"
humanReviewMode: "ask"
...
deliveryEvidence:
    version: 1
    mode: "worktree_merge"
    executionCommit: "4d34699803daaca4ccb94d8447ab3ac337eb01e1"
    targetBranch: "main"
...
- Mutation proof (perform manually, then revert): skipping the real login operation fails an auth/onboarding test;
  clearing the selected default after the `/model` flow fails an onboarding test; removing the root `switchAgent` call
  fails the root-activation assertions. Do not target redundant wrapper calls: remove them if the real authority already
  owns the behavior.
