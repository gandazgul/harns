 ...
 */
export function createRunWieldGrepToolDefinition(cwd) {
    ...
    tool.execute = async (toolCallId, params, signal, onUpdate, ctx) => {
        const grepParams = /** @type {RunWieldGrepParams} */ (params);
