...
If a significant refactor is needed, state the concrete limit and offer user-owned options, such as `/agent planner` for
a planned refactor or continuing with a smaller optimization request.
